...
CREATE TABLE IF NOT EXISTS "DDS".transaction_pos (
	...
	CONSTRAINT transaction_pos_pk PRIMARY KEY (transaction_id)
);
...
CREATE TABLE IF NOT EXISTS "DDS"."transaction" (
	...
	CONSTRAINT transaction_fk_1 FOREIGN KEY (transaction_id) REFERENCES "DDS".transaction_pos(transaction_id)
);